...
/**
 * 1 改变BottomBar的颜色
 * 2 tab只显示icon，不显示title  app:bb_behavior="shifting"
 */
public class BottomBarColorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bottombar_color);


        toast = Toast.makeText(BottomBarColorActivity.this, "", Toast.LENGTH_SHORT);
